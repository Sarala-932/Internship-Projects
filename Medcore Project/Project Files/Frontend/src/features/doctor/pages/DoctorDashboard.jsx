    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden flex flex-col">
        <div className="px-6 py-5 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/50">
          ...
          <button onClick={async () => { setIsRefreshing(true); await refreshStats(); setIsRefreshing(false); }} className="cursor-pointer text-slate-500 hover:text-blue-600 transition-colors" title="Refresh Dashboard">
